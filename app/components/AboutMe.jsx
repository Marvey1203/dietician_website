    ...
    return ( 
        <div className="w-full flex flex-col justify-center items-center" id="about">
            <div className="w-3/4 ">
                ...
                <p className="text-[15px] md:text-xl py-7 font-primary"> 
                ...
                <div className="flex lg:flex-row flex-col lg:gap-1 gap-4 justify-center items-center py-10">
                    ...
                    <h2 className=" w-full md:text-4xl text-2xl font-bold text-center uppercase font-primary">Special Interests</h2>
                    <div className="lg:w-[80%] w-full h-[2px] bg-black"></div>
                </div>
