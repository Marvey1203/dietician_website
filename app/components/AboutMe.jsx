            ...
            <div className="w-3/4 ">
                ...
                <div className="w-full flex lg:flex-row flex-col">
                    ...
                    <div className="lg:w-[60%] w-full flex flex-col md:justify-end md:items-end justify-start items-start gap-5 lg:pl-8 pt-10">
                        ...
                        <p className="md:text-justify  text-[15px] md:text-xl md:tracking-[0.25em] font-primary">
                ...
                <p className="md:text-justify  text-[15px] md:text-xl md:tracking-[0.25em] py-7 font-primary"> 
