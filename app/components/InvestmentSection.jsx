const InvestmentSection = () => {
    return ( 
        <div className="w-full relative pt-20 md:pt-28">
            <img className="w-full h-full bg-cover" src="/healthsection.svg" alt="Grean healthy background image with lemons and leaves" />
